...
<figure className="max-w-screen-md">
    ...
    <blockquote>
        <p className="text-2xl font-semibold text-gray-500 dark:text-gray-400">The electronic product website offers a sleek and user-friendly design, comprehensive product listings, competitive pricing, efficient customer service, and a convenient shopping experience for tech enthusiasts.</p>
    </blockquote>
    <figcaption className="flex items-center mt-6 space-x-3">
        ...
        <div className="flex items-center divide-x-2 divide-gray-300 dark:divide-gray-700">
            <cite className="pr-3 font-medium text-gray-500 dark:text-gray-400">Bonnie Green</cite>
            <cite className="pl-3 text-sm text-gray-500 dark:text-gray-400">Regular Customer</cite>
        </div>
    </figcaption>
</figure>
